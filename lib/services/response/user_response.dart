import 'package:login/services/request/user_request.dart';
...
class CreateUserResponse {
  ...
  doCreate(String username, String password, String name, String lastname, String surname, String email, String phone, int birthdate) {
    var fido = User(username, password, name, lastname, surname, email, phone, birthdate);
